...
<form class="layui-form" action="" enctype="multipart/form-data" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="category_name" value="<?php echo $date['category_name']?>" required lay-verify="required" placeholder="分类名称" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="level" lay-verify="required">
                <option value=""></option>
                <option    {if $date['level']==1} selected {/if} value="1">一级</option>
                <option  {if $date['level']==2} selected {/if} value="2">二级</option>
            </select>
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    ...
    layui.use(['form', 'upload', 'jquery', 'layedit'], function () {
        ...
        form.on('submit(formDemo)', function (data) {
            ...
            jquery.post("http://www.admin.com/?r=category/update_do", data.field, function (res) {
                alert(res);
                if (res.code < 0) {
