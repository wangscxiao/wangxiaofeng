    ...
    <script>
        ...
        layui.use(['laydate', 'jquery', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function () {
            ...
            table.render({
                ...
                , totalRow: true //开启合计行
                , url: "http://www.admin.com/?r=pic/list_do" //数据接口
                , page: true //开启分页
                , cols: [[ //表头
                    {type: 'checkbox', fixed: 'left'}
                    , {field: 'id', title: 'ID', width: 80, sort: true, fixed: 'left'}
                    , {field: 'title', title: '图片名称', width: 110, edit: 'text', sort: true}
                    , {field: 'url', title: '链接地址', width: 160}
                    , {field: 'pic', title: '图片链接', width: 110}
            ...
            table.on('toolbar(test)', function (obj) {
                ...
                switch (obj.event) {
                    case 'add':
                        layer.open({
                            type: 2,
                            content: "http://www.admin.com/?r=pic/add_list", //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
                            area: ['600px', '500px'],
                            scrollbar: true,
            ...
            table.on('tool(test)', function (obj) {
                ...
                if (layEvent === 'detail') {
                    ...
                    layer.confirm('真的删除么', function (index) {
                        jquery.ajax({
                            url: "http://www.admin.com/?r=pic/delete",
                            type: "POST",
                   ...
                   // alert(data.id);
                    layer.open({
                        type: 2,
                        content: "http://www.admin.com/?r=pic/update/&id=" + data.id, //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
                        area: ['800px', '600px'],
