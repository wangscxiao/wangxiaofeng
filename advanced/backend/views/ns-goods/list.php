...
<div class="layui-layout layui-layout-admin">
    ...
    <script type="text/html" id="switchTpl">
        ...
        <input type="checkbox" name="is_recommend"
               value="{{d.goods_id}}" lay-skin="switch" lay-text="推荐|不推荐" lay-filter="sexDemo" {{
               d.is_recommend== 1 ? 'checked' : '' }}>
    </script>
    <script>
        //JavaScript代码区域
        layui.use(['laydate','form', 'jquery', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function () {
            ...
            table.render({
                ...
                , totalRow: true //开启合计行
                , url: "http://www.admin.com/?r=ns-goods/list_do" //数据接口
                , page: true //开启分页
                , cols: [[ //表头
                    {type: 'checkbox', fixed: 'left'}
                    , {field: 'goods_id', title: 'ID', width: 60, sort: true, fixed: 'left'}
                    , {field: 'goods_name', title: '商品名称', width: 110, edit: 'text', sort: true}
                    , {field: 'goods_pic', title: '商品图片', width: 110}
                    , {field: 'present_price', title: '商品规格', width: 110}
                    , {field: 'is_recommend', title: '是否推荐', width: 100, templet: '#switchTpl', sort: true}
                    , {field: 'original_price', title: '原价', width: 110}
                    , {field: 'goods_spec', title: '现价', width: 110}
                    , {field: 'sort', title: '排序', width: 110}
                    , {field: 'create_time', title: '添加时间', width: 110}
                    , {field: 'category', title: '商品分类ID', width: 80}
                    , {field: 'number', title: '商品数量', width: 80}
                    , {field: 'description', title: '商品详情', width: 110}
            ...
            table.on('toolbar(test)', function (obj) {
                ...
                switch (obj.event) {
                    case 'add':
                        layer.open({
                            type: 2,
                            content: "http://www.admin.com/?r=ns-goods/add_list", //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
                            area: ['600px', '500px'],
                            scrollbar: true,
                ...
                if (layEvent === 'detail') {
                    ...
                    layer.confirm('真的删除么', function (index) {
                        ...
                        jquery.ajax({
                            ...
                            url: "http://www.admin.com/?r=ns-goods/delete",
                            type: "POST",
                    ...
                    layer.open({
                        type: 2,
                        content: "http://www.admin.com/?r=ns-goods/update/&goods_id=" + data.goods_id, //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
                        area: ['800px', '600px'],
            ...
            form.on('switch(sexDemo)', function (obj) {
                console.log(obj);
                jquery.ajax({
                    url: "http://www.admin.com/?r=ns-goods/recommend",
